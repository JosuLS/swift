...
class PrincipalTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "MiCelda", for: indexPath) as! MiCeldaTableViewCell

        // Configure the cell...

        cell.eitqueta.text = String(indexPath.row)
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if( segue.identifier == "showVCsegue" ){
            ...
            destino.posicion = emisor.eitqueta.text         }
